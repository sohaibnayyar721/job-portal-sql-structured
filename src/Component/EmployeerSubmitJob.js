...
function EmployeerSubmitJob() {
    ...
    console.log("this is job description", jobDescription)
    ...
    console.log("this is parse jobsss description", getText)

    // ---------------------END---------------------
    const isValid = (
        !jobTitle || desVal || !category ||
        ...
        <div className='flex relative overflow-y-auto h-[88vh] flex-col gap-8 w-full  bg-[#eeeeee99] px-12 py-6'>
            ...
            </div>
            {
                ...
                showError
                    ?
                    <div>
                        {!jobTitle || getText || !category || phoneNumberValidator
                            ...
                            <div className='bg-[#fcd9db] rounded-md p-4 border-[1px] border-[#feb8ba]'>
                                ...
                                <div className='pl-9'>
                                    ...
                                    {getText ? <div><li>Job Description</li></div> : ""}
