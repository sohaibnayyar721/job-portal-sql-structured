...
function EmployeerSubmitJob() {
    ...
    // let [desVal, setDesVal] = useState(true)
    // let getText = parse(jobDescription)
    // useEffect(() => {

    //     if (parse(jobDescription)?.props?.children === undefined) {
    //         setDesVal(true)
    //         console.log("this is if statement")
    //     }
    //     else if (parse(jobDescription)?.props?.children?.props?.children === undefined) {
    //         setDesVal(true)
    //         console.log("this is else if statement")    
    //     }
    //     else {
    //         setDesVal(false)
    ...
    function handleJobDescription(value){
        setJobDescription(value)
    }

  

    console.log("this is job description", jobDescription?.replace(/<(.|\n)*?>/g, '').trim())

    // ---------------------END---------------------
    const isValid = (
        !jobTitle || !jobDescription?.replace(/<(.|\n)*?>/g, '').trim() || !category ||
        ...
        <div className='flex relative overflow-y-auto h-[88vh] flex-col gap-8 w-full  bg-[#eeeeee99] px-12 py-6'>
            ...
            </div>
            {
                ...
                showError
                    ?
                    <div>
                        {!jobTitle  || !category || phoneNumberValidator
                            ...
                            <div className='bg-[#fcd9db] rounded-md p-4 border-[1px] border-[#feb8ba]'>
                                ...
                                <div className='pl-9'>
                                    ...
                                    {jobDescription ? <div><li>Job Description</li></div> : ""}
